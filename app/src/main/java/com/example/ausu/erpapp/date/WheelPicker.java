...
public class WheelPicker extends View implements IDebug, IWheelPicker, Runnable {
    ...
    public interface OnWheelChangeListener {
         ...
         *              {@link com.aigestudio.wheelpicker.WheelPicker#SCROLL_STATE_IDLE}
         *              表示滚动选择器处于静止状态
         *              {@link com.aigestudio.wheelpicker.WheelPicker#SCROLL_STATE_DRAGGING}
         *              表示滚动选择器处于拖动状态
         *              {@link com.aigestudio.wheelpicker.WheelPicker#SCROLL_STATE_SCROLLING}
         *              表示滚动选择器处于滑动状态
         *              <p>
